...
var CreateDailySaleComponent = /** @class */ (function () {
    ...
    CreateDailySaleComponent.prototype.addDailySale = function () {
        ...
        for (var i = 0; i < this.dataset.length; i++) {
            if (this.dataset[i].qty_in_inventory == 0) {
                this.layoutUtilsService.showActionNotification('erreur : Le Produit ' + this.dataset[i].description + ' n\'existe pas dans le stock', _core_base_crud__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Delete, 5000, true, true);
                this.loading = false;
                return null;
            }
            ;
