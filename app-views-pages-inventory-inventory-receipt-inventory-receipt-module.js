...
var CreateReceiptComponent = /** @class */ (function () {
    ...
    CreateReceiptComponent.prototype.addInventoryReceipt = function () {
        ...
        var d1 = this.dataset;
        var d2 = this.receptionDetailsByProduct;
        var tableContent = "";
        for (var i = 0; i < d1.length; i++) {
            var s = "\n      <tr>\n          <td></td> <!-- Don't remove this column as it's needed for the row commands -->\n          <td>" + d1[i]['product_code'] + "</td>\n          <td>" + d1[i]['description'] + "</td>\n          <td>" + d1[i]['received_qty'] + "</td>\n          <td>" + d1[i]['purchase_price'].toFixed(2) + "</td>\n          <td>" + d1[i]['total_price'].toFixed(2) + "</td>\n          <td></td>\n\n        </tr>\n      ";
            tableContent = tableContent + s;
        }
        for (var i = 0; i < d2.length; i++) {
            var s = "\n      <tr>\n          <td></td> <!-- Don't remove this column as it's needed for the row commands -->\n          <td>" + d2[i]['product_code'] + "</td>\n          <td>" + d2[i]['description'] + "</td>\n          <td>1</td>\n          <td></td>\n          <td></td>\n          <td>" + d2[i]['serial_number'] + "</td>\n\n        </tr>\n      ";
            tableContent = tableContent + s;
        }
        ...
        this.inventoryService.addInventoryReceipt({
            ...
            _this.printReceipt(result['ir'], tableContent);
